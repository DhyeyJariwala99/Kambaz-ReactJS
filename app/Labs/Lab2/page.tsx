    ...
    <div id="wd-lab2">
      ...
      <div id="wd-css-position-fixed">
        ...
        <div style={{ 
          ...
          Blue Fixed position rectangle does not scroll with rest of page
        </div>
      </div>
      ...
      <div id="wd-css-bootstrap-tables">
        ...
        <table className="table table-striped table-bordered">
          ...
          <tbody>
            <tr><td>Q1</td><td>HTML</td><td>19/3/23</td><td>100</td></tr>
            <tr><td>Q2</td><td>CSS</td><td>1/13/23</td><td>100</td></tr>
            <tr><td>Q3</td><td>JavaScript</td><td>19/7/23</td><td>100</td></tr>
          </tbody>
        </table>
      ...
      <div id="wd-css-bootstrap-lists">
        ...
        <ul className="list-group">
          <li className="list-group-item active">Shinchan</li>
          <li className="list-group-item">Doraemon</li>
          <li className="list-group-item">Inception</li>
          <li className="list-group-item">The Avengers</li>
        </ul>
        ...
        <form style={{ maxWidth: '800px' }}>
          ...
          <div className="row mb-3">
            <div className="col-12">
              ...
              <input type="email" placeholder= 'DJ@gmail.com' className="form-control" />
            </div>
          </div>
      ...
      <div id="wd-css-bootstrap-pills" style={{ marginTop: '30px' }}>
        ...
        <ul className="nav nav-pills mb-3">
          ...
          <li className="nav-item">
            <a className="nav-link" href="/Labs/Lab3">Lab 3</a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="/">Kambaz</a>
          </li>
        </ul>
        
        <h3>Link to GitHub Repository</h3>
        <a href="https://github.com/DhyeyJariwala99/Kambaz-ReactJS/tree/main" 
